...
## Latest Updates
- 🚀 **[2026-07]** A new pre-trained model is now available on [google drive](https://drive.google.com/drive/folders/1cqapZOsJmlrVYiKbKADnDzilU7eZML27?usp=drive_link), offering stronger generalization performance. It is trained on a non-redundant dataset compiled from the **RNAstralign, bpRNA, and RNAsolo2** databases (CD-HIT **0.92**), covering RNA sequences ranging from **600 to 5,000** nucleotides in length. The model achieves an F1 score of **~0.67** on the held-out test set. The complete training and test datasets are also publicly available on [google drive](https://drive.google.com/drive/folders/1cqapZOsJmlrVYiKbKADnDzilU7eZML27?usp=drive_link) for direct access and benchmarking.
...
```
>._RNAStrAlign_16S_rRNA_database_Bacilli_DQ643100.ct

>._RNAStrAlign_16S_rRNA_database_Actinobacteria_DQ026645.ct

```
